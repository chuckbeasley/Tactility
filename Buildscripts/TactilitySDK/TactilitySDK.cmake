...
# Backward-compatible single-shot project setup (used by Tests/SdkIntegration and locally
# generated apps that predate the pre/post split).
...
# New interface split into a pre/post pair around project(), matching the apps repo
# (Apps/*/CMakeLists.txt call tactility_project_pre/post and tactility_component_register).
...
# Wraps idf_component_register() and always pulls in the TactilitySDK umbrella component
# (which transitively links the base libs and every module).
